                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="tp-slider-wrapper mt-60 position-relative">
                                            ...
                                            <a class="popup-video" href="https://www.youtube.com/watch?v=lTNYjdP-VUc" target="_blank" rel="noopener"><i class="fas fa-play"></i></a>
                                        </div>
                                                                                <div class="tp-slider z-index">
                                                                                        <h5 class="tp-slider-subtitle common-yellow-shape w-80 mb-35 bdevs-el-subtitle" data-animation="fadeInUp2" data-delay=".5s">Fast and efficient service</h5>

                                                                                        <h1 class="tp-slider-title mb-45 bdevs-el-title" data-animation="fadeInUp2" data-delay=".8s">India’s Most <br>Trusted Agency For<br><span class="typed-me" data-string0="All Work Househelp" data-string1="Cleaner" data-string2="Cook" data-string3="Aayah" data-string4="BabySitter" data-string5="Japa Maid" data-string6="Driver" data-string7="Caretaker " data-string8="Watchman" data-type-speed="40" data-start-delay="0" data-backspeed="40" data-back-delay="500" data-loop="1"></span></h1>


                                                                                        <div class="tp-slider-btn bdevs-el-btn" data-animation="fadeInUp2" data-delay="1.1s">
                                                <a href="https://maidservicesinindia.com/services/" class="theme-btn"><i class="flaticon-enter"></i> All Services</a>
                                            </div>
                                                                                    </div>
                                    </div>
                                </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="d-flex align-items-center justify-content-between bg-light p-4">
                        <h5 class="text-truncate me-3 mb-0">Domestic worker</h5>
                    ...
                    <div class="container">
                        <div class="row g-4">
                            <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.1s">
                                ...
                                <div class="d-flex align-items-center justify-content-between bg-light p-4">
                                    <h5 class="text-truncate me-3 mb-0">cleaner</h5>
                                    <a class="btn btn-square btn-outline-primary border-2 border-white flex-shrink-0" href=""><i class="fa fa-arrow-right"></i></a>
                                </div>
                            </div>
